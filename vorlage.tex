%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                                         %%
%%                  LaTeX Template for the Students of                     %%
%%    Duale Hochschule Baden-Württemberg Ravensburg                        %%
%%                                                                         %%
%%  The template is based on the design guidelines of the DHBW RV          %%
%%                                                                         %%
%%                                                                         %%
%% Creator:         Markus Schutz (WI06)                                   %%
%% Last modified:   November 26, 2013                                      %%
%%                                                                         %%
%%                                                                         %%
%% Important note on using this template:                                  %%
%%                                                                         %%
%% For the template to be used and the PDF to be generated correctly and   %%
%% completely, a manual call to makeindex is required. These can optionally%%
%% be set up directly in the editor.                                       %%
%% TeXnicCenter (Output -> Define output profiles... (Alt + F7)            %%
%%               LaTeX => PDF -> Postprocessing)                           %%
%%                                                                         %%
%% (1) Keyword index (if used)                                             %%
%% makeindex -g -s styles\stichwortverzeichnis.ist template                %%
...
%%                                                                         %%
%% When generating the PDF file (using the LaTeX => PDF output profile)    %%
%% the abbreviations index, keyword index, and glossary are now generated  %%
%% correctly. When using TeXnicCenter, there may be issues with automated  %%
%% calls to makeindex. A manual call always works.                         %%
%%                                                                         %%
%% Important note:                                                         %%
%%                                                                         %%
%% Do not make changes to the files in the "pages" directory. For the work,%%
%% all changes refer to this file and the files in the "chapter" directory.%%
%% For creating the bibliography, it is recommended to use JabRef          %%
%% (http://jabref.sourceforge.net). The file should be saved under the name%%
%% literature.bib in the "literature" directory.                           %%
%%                                                                         %%
%% To make sensible use of this template, it is recommended to read the    %%
%% documentation for the included packages. They can be found in the doc   %%
%% directory of the MiKTeX installation.                                   %%
%%                                                                         %%
%% Included title pages:                                                   %%
%%   - Seminar paper                                                       %%
%%   - Project report                                                      %%
%%   - Bachelor's thesis                                                   %%
%%                                                                         %%
...
\usepackage[toc,style=altlist,translate=false]{glossaries}                    % Glossary (after hyperref, inputenc, babel, and ngerman)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                                         %%
%% \/   \/      Please make changes to the work below            \/   \/ %%
%%                                                                         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%% Definitions regarding the work %%%%%%%%%%%%%%%%%%%%%%%
\def\myType{1}           % [0=Seminar paper|1=Project report|2=Bachelor's thesis]

\def\myTopic{}
\def\mySubTopic{}
\def\myAutor{Francisco Rodriguez Müller}
\def\matrikelnr{2775857}
\newcommand{\kurs}{RV-WWIBE122}
\def\myCompany{All for One Group SE}
\def\myCompanyAddressStreet{Danziger Straße 7}
\def\myCompanyAddressCity{88250 Weingarten}
\def\myProf{Prof. Dr. Frank Lehmann}
\def\myEndDate{30.09.2024}

%%%%%%%%%%%%%%%%%%%% Following information for: Seminar paper %%%%%%%%%%%%%%%%%%%%
\def\myVorlesung{Lecture Name}

%%%%%%%%%%%%%%%%%%%% Following information for: Project report %%%%%%%%%%%%%%%%%%%%
