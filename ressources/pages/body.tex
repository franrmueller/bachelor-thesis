...
% I have to add here a defence on why i decided to put all this information here and not in the literature review (recent- not so hardcore academic sources). And also defend that I used this "gray" literature because they represent cutting-edge progress on this developing techonology.
...
\begin{figure}[h!]
  ...
  \fbox{\parbox{0.92\linewidth}{
    ...
    Show: User \\to\ Orchestrator \\to\ {Researcher, Analyst, Reviewer, Writer\ } \\to\ Tool Adapters (\textbf{MCP} servers, APIs, RAG); optional \textbf{A2A} links to external agents.
  }}
