...
\begin{figure}[H]
  \centering
  \includegraphics[width=.95\linewidth]{ressources/MAS/diagrams/fig-model-based-representation.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{ressources/MAS/diagrams/fig-architecture.pdf}
  \caption{High-level architecture with layered responsibilities.}\label{fig:top-level-arch}
\end{figure}
