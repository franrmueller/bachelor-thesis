...
I hereby declare that I have written the present bachelor’s thesis \textbf{independently} 
and that I have not used any sources or aids other than those indicated.  
All passages that were taken from published or unpublished works are 
\textbf{clearly marked as such}. This thesis has not been submitted to any other 
examination authority in the same or a similar form. \\[1.5cm]
\vfill
\noindent
Thesis Title: \\
\textbf{\myTitle} \\
