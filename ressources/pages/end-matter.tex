...
% \subsection*{A.2 Requirements model (figure)}
% \begin{figure}[h!]
%   \centering
%   \includesvg[width=.95\linewidth]{ressources/diagrams/fig-model-based-representation.svg}
%   %\includegraphics[width=.95\linewidth]{ressources/diagrams/fig-model-based-representation.svg}
%   \caption{Requirements model used in Section~\ref{fig:req-model}.}
% \end{figure}

% \subsection*{B.1 Architecture diagram (figure)}
% \begin{figure}[h!]
%   \centering
%   \includesvg[width=.95\linewidth]{ressources/diagrams/fig-architecture.svg}
%   %\includegraphics[width=.95\linewidth]{ressources/diagrams/fig-architecture.svg}
%   \caption{Architecture diagram used in Section~\ref{fig:arch}.}
% \end{figure}

% \subsection*{B.2 Traceability diagram (figure)}
% \begin{figure}[h!]
%   \centering
%   \includesvg[width=.95\linewidth]{ressources/diagrams/fig-traceability.svg}
%   %\includegraphics[width=.95\linewidth]{ressources/diagrams/fig-traceability.svg}
%   \caption{Traceability diagram used in Section~\ref{fig:trace}.}
% \end{figure}
