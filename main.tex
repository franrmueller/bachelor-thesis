...
\newcommand{\myTitle}{Designing a Multi-Agent Architecture for Workflow Automation}
\newcommand{\mySubtitle}{A Framework for Operational Excellence}
...
\usepackage{chngcntr}
\usepackage{booktabs}
%\usepackage{tikz}   \usetikzlibrary{arrows.meta,positioning,fit,shapes,calc}    \usepackage{tikz-uml}
...
\begin{document}
\include{ressources/pages/preliminaries}
\include{ressources/pages/body}
\include{ressources/pages/end-matter}                               
\end{document}